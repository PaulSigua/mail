...
a persistence unit "mailPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "mail/pom.xml":
...
artifact ("mail.war") is already built. You can build
